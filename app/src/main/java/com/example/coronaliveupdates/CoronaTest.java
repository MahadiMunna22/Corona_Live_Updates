...
public class CoronaTest extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://coronastatebd.mist.ac.bd/checker/index.php");
